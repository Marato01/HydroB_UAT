...
import '../deskboard_screen/button_navigation_bar/button_navigation_bar.dart';
import 'dialog/delete_area_dialog.dart';
import 'dialog/name_area_dialog.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        leading: GestureDetector(
            onTap: (){
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const AddVegetable()));
            },
